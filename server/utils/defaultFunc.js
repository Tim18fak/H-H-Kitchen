...
const ActivationCodeEmail = (...args) => {
  ...
  async function sendActivationCode(res, transporter, data, id) {
    try {
      ...
      res.status(201).json({
        message:
          'You account has been created and your Activation Code was sent to your email',
        id,
      })
    } catch (error) {
      console.error(error)
...
module.exports = { ActivationCode, ActivationCodeEmail, timeBan, transporter, dID };
